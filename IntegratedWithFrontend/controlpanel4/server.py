...
def BackendData():
    ...
    if request.method=='POST':
        ...
        print("BatchSize is ",sum(l))
        print("Threshold is ",Threshold)
        print("Nbatch is ",Nbatch)

        BackendData={"FullData":data_put.tolist(),"XYData":XYData_put.tolist(),"color_list":color_list_put.tolist(),"Nbatch":[Nbatch],"Threshold":[Threshold],"BatchSize":[sum(l)],"FileName":[FileName]}
        return BackendData
        ...
        BackendData={"FullData":data_get.tolist(),"XYData":XYData_get.tolist(),"color_list":color_list_get.tolist(),"Nbatch":[Nbatch],"Threshold":[Threshold],"BatchSize":[sum(l)],"FileName":[FileName]}
        return BackendData

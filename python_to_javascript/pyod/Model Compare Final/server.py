...
def BackendData():
    ...
    if request.method=='POST':
        ...
        if (FileName=="HR_diagram.csv"):
            ...
            print("\nOn Training Data:")
            if len(y_train) == len(y_test_pred3):
                evaluate_print(clf_name, y_train, y_train_pred3)
            ...
            print("\nOn Test Data:")
            if len(y_test) == len(y_test_pred3):
                evaluate_print(clf_name, y_test, y_test_pred3)
            ...
            print("Acc_dif_train = ", acc_dif_train)
            print("Acc_dif_test = ", acc_dif_test)
            ...
            print("ADD Data: ", AddingData)
            print("Del Data: ", DeletingData)
            print("XYData", XYDatalst) 
